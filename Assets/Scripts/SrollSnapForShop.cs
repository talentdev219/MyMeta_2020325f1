...
public class ScrollSnapForShop : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public string namesample1, namesample2, namesample3;
    ...
    void Update()
    {
        if (_currentPage == 1)
        {
            nametext.text = namesample1;
        }

        if (_currentPage == 2)
        {
            nametext.text = namesample2;
        }

        if (_currentPage == 3)
        {
            nametext.text = namesample3;
        }
